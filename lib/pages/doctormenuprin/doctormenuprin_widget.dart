...
import 'doctormenuprin_model.dart';
export 'doctormenuprin_model.dart';

class DoctormenuprinWidget extends StatefulWidget {
  const DoctormenuprinWidget({Key? key}) : super(key: key);

  @override
  _DoctormenuprinWidgetState createState() => _DoctormenuprinWidgetState();
}

class _DoctormenuprinWidgetState extends State<DoctormenuprinWidget>
    with TickerProviderStateMixin {
  late DoctormenuprinModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DoctormenuprinModel());
