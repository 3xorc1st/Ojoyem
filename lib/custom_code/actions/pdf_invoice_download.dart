      ...
      build: (pw.Context context) {
        return pw.Column(
          ...
          children: [
            ...
            pw.Text('Resultado de escaneo', style: pw.TextStyle(fontSize: 24)),

            // Add the image taken before
            pw.SizedBox(height: 20),
            pw.Image(netImage),

            // Add the table with random numbers
            pw.SizedBox(height: 20),
            pw.Table.fromTextArray(
              headerStyle: pw.TextStyle(fontWeight: pw.FontWeight.bold),
              data: [
                ['Numero de pixeles', 'Resultado'],
                // Replace the next two rows with your actual random numbers
                ['123', '456'],
                ['789', '987'],
              ],
            ),
